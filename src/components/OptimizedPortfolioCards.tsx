...
export const OptimizedPortfolioCards = memo<OptimizedPortfolioCardsProps>(({ portfolioData }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
      <Card className="p-4 sm:p-6 bg-gradient-crypto border-border">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-lg sm:text-2xl font-bold text-accent font-mono tracking-wider">
      ...
      <Card className="p-4 sm:p-6 bg-gradient-crypto border-border">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <p className="text-xs sm:text-sm text-muted-foreground font-inter">{t('portfolio.change')}</p>
              {source === 'wallet' && (
            ...
            <p className={`text-lg sm:text-2xl font-bold font-mono tracking-wider ${dailyChange >= 0 ? 'text-success' : 'text-destructive'}`}>
      ...
      <Card className="p-4 sm:p-6 bg-gradient-crypto border-border">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-lg sm:text-2xl font-bold text-foreground font-mono tracking-wider">{activeTrades}</p>
          </div>
        </div>
      </Card>
    </div>

...
export const UpcomingAdvisors = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-gradient-to-r from-purple-900/30 via-blue-900/30 to-purple-900/30 border-purple-500/30 backdrop-blur-sm">
        <div className="text-center space-y-3">
          ...
          <p className="text-purple-400/90 text-sm max-w-2xl mx-auto">
            每一位大师都将为你的财富征程提供独特的战略支持，与你并肩作战，共同征服金融市场
          </p>
          <Badge className="bg-gradient-to-r from-amber-600/20 to-purple-600/20 text-amber-300 border-amber-500/30 px-4 py-2 animate-pulse">
